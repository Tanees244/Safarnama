...
import ActiveTicket from './ActiveTicketB';
    ...
    <View style={styles.Container}>
      ...
      <Svg height="500%" width="500%" style={styles.backgroundEllipse1}>
        ...
        <View style={styles.headerTextContainer}>
          ...
          <Text style={[ { color: 'white', fontFamily: 'Poppins-Bold', fontSize: 22 }]}>Faisal Movers</Text>
        </View>
        <Image source={require('../../assets/faisalmover.png')} style={styles.headerImage} />
      </View>
      <TouchableOpacity
