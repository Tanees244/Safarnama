...
const ActiveTicketB = ({ ticketDetails: initialTicketDetails, ticketNumber, onUpdateTicket, onDeleteTicket }) => {
  ...
  return (
    ...
    <View style={styles.flightInfoContainer}>
      <Text style={styles.flightNumber}> Bus # {ticketDetails.bus_number}</Text>
    </View>
    ...
    <View style={styles.seatTypeContainer}>
      <View style={[
        ...
        ticketDetails.seat_type && ticketDetails.seat_type.trim().toLowerCase() === 'luxury' && styles.selectedSeat
      ]}>
      ...
      <View style={[
        styles.seatTypeOption,
        ticketDetails.seat_type && ticketDetails.seat_type.trim().toLowerCase() === 'standard' && styles.selectedSeat
      ]}>
