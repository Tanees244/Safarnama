  ...
  return (
    <View style={[styles.activeTicketContainer , { width: containerWidth }]}>
        ...
        <View style={styles.flightInfoContainer}>
            <Text style={styles.flightName}>Faisal Movers</Text>
            <Text style={styles.flightNumber}>{ticketDetails.BusNumber}</Text>
        </View>
            ...
            <View style={styles.ticketText}>
              <View style={styles.Time}>
                ...
                <View style={styles.Duration}>
                  ...
                  <View>
                  <Text style={styles.title}>Travel Duration:</Text>
      ...
      <View style={styles.modalContent}>
        ...
        <View style={styles.input}>
          <Dropdown
            defaultValue={editedTicket.flightType || 'Bus Type'} 
            options={seatTypes}
            textStyle={styles.DropdownText}
            dropdownStyle={styles.DropdownContainer}
            dropdownTextStyle={styles.CustomDropdownText}
