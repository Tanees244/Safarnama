...
const GuideUserReview = () => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.Container} >
            ...
            <ImageBackground style={styles.Rectangle1} source={require("../../assets/4.jpg")}>
                <Text style={{ color: 'black', fontSize: 28, fontFamily:'Poppins-SemiBold', left: 20, top: 200}}>User Reviews</Text>
