      ...
      <View style={styles.seatTypeContainer}>
        <View
          style={[
            ...
            ticketDetails.flightType &&
              ticketDetails.flightType.trim().toLowerCase() === "first-class" &&
              styles.selectedSeat,
          ]}
        >
        ...
        <View
          style={[
            styles.seatTypeOption,
            ticketDetails.flightType &&
              ticketDetails.flightType.trim().toLowerCase() === "business" &&
              styles.selectedSeat,
          ]}
        >
        ...
        <View
          style={[
            styles.seatTypeOption,
            ticketDetails.flightType &&
              ticketDetails.flightType.trim().toLowerCase() === "economy" &&
              styles.selectedSeat,
          ]}
        >
          ...
          <View style={styles.Time}>
            <View style={styles.DTime}>
              ...
              <Text style={styles.ticketText2}>
                {(editedTicket.departureDate &&
                  new Date(editedTicket.departureDate)?.toDateString()) ||
                  " "}
              </Text>
              <Text style={styles.title2}>Departure Time : </Text>
              <Text style={styles.ticketText2}>
                {(editedTicket.departureTime &&
                  new Date(editedTicket.departureTime)?.toLocaleTimeString()) ||
                  " "}
              </Text>
            </View>
            <View style={styles.ATime}>
              ...
              <Text style={styles.ticketText2}>
                {(editedTicket.arrivalDate &&
                  new Date(editedTicket.arrivalDate)?.toDateString()) ||
                  " "}
              </Text>
              <Text style={styles.title2}>Arrival Time : </Text>
              <Text style={styles.ticketText2}>
                {(editedTicket.arrivalTime &&
                  new Date(editedTicket.arrivalTime)?.toLocaleTimeString()) ||
                  " "}
              </Text>
            </View>
          </View>
